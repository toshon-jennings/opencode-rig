export const dict = {
  ...
  "prompt.context.pin": "컨텍스트 고정",
  "prompt.context.unpin": "컨텍스트 고정 해제",
  ...
  "session.timeline.steer": "방향 전환",
  "session.timeline.queue": "대기열",
  "session.timeline.steerHint": "입력하여 이 응답의 방향을 바꿉니다",
  "session.timeline.queueHint": "이 응답 후에 보낼 메시지를 입력하세요",
  ...
  "status.popover.tab.providers": "제공업체",
  ...
  "settings.providers.health.operational": "정상",
  "settings.providers.health.degraded": "성능 저하",
  "settings.providers.health.unreachable": "연결 불가",
  "settings.providers.autoDiscovery.banner": "{{provider}}의 새 모델을 발견했습니다",
  ...
  "toast.followup.mode.queue": "후속 조치 모드가 Queue로 설정됨",
  "dialog.mcp.inspector.tools": "연결된 도구",
  "dialog.mcp.inspector.noTools": "이 서버에 등록된 도구가 없습니다",
  "dialog.mcp.inspector.notConnected": "서버가 연결되지 않았습니다",
  "dialog.mcp.inspector.schema": "입력 스키마",
  "dialog.mcp.inspector.expand": "서버 세부정보 펼치기",
  "dialog.mcp.inspector.collapse": "서버 세부정보 접기",
  "dialog.mcp.inspector.required": "필수",
}
