export const dict = {
  "desktop.updater.dialog.available.message": "アップデート {{version}} を利用できます。ダウンロードページを開きますか？",
  "desktop.updater.dialog.available.title": "アップデートが利用可能です",
  ...
  "prompt.context.pin": "コンテキストを固定",
  "prompt.context.unpin": "コンテキストの固定を解除",
  ...
  "session.timeline.steer": "誘導",
  "session.timeline.queue": "キュー",
  "session.timeline.steerHint": "入力してこの応答の方向を変える",
  "session.timeline.queueHint": "この応答の後に送るメッセージを入力",
  ...
  "status.popover.tab.providers": "プロバイダー",
  ...
  "settings.providers.health.operational": "稼働中",
  "settings.providers.health.degraded": "低下",
  "settings.providers.health.unreachable": "到達不能",
  "settings.providers.autoDiscovery.banner": "{{provider}} の新しいモデルが見つかりました",
  ...
  "toast.followup.mode.queue": "フォローアップモードをQueueに設定しました",
  "dialog.mcp.inspector.tools": "接続中のツール",
  "dialog.mcp.inspector.noTools": "このサーバーに登録されているツールはありません",
  "dialog.mcp.inspector.notConnected": "サーバーが接続されていません",
  "dialog.mcp.inspector.schema": "入力スキーマ",
  "dialog.mcp.inspector.expand": "サーバーの詳細を展開",
  "dialog.mcp.inspector.collapse": "サーバーの詳細を折りたたむ",
  "dialog.mcp.inspector.required": "必須",
}
