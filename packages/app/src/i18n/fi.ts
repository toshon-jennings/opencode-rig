export const dict = {
  ...
  "prompt.context.pin": "Kiinnitä konteksti",
  "prompt.context.unpin": "Irrota konteksti",
  ...
  "session.timeline.steer": "Ohjaa",
  "session.timeline.queue": "Jono",
  "session.timeline.steerHint": "Kirjoita ohjataksesi tätä vastausta",
  "session.timeline.queueHint": "Kirjoita jatkoviesti lähetettäväksi tämän vastauksen jälkeen",
  ...
  "status.popover.tab.providers": "Palveluntarjoajat",
  ...
  "settings.providers.health.operational": "Toiminnassa",
  "settings.providers.health.degraded": "Heikentynyt",
  "settings.providers.health.unreachable": "Ei tavoitettavissa",
  "settings.providers.autoDiscovery.banner": "Uusia malleja löydettiin palvelulle {{provider}}",
  ...
  "toast.followup.mode.queue": "Seuranta-tilaksi asetettu Queue",
  "dialog.mcp.inspector.tools": "Yhdistetyt työkalut",
  "dialog.mcp.inspector.noTools": "Tälle palvelimelle ei ole rekisteröity työkaluja",
  "dialog.mcp.inspector.notConnected": "Palvelin ei ole yhdistetty",
  "dialog.mcp.inspector.schema": "Syöteskeema",
  "dialog.mcp.inspector.expand": "Laajenna palvelimen tiedot",
  "dialog.mcp.inspector.collapse": "Tiivistä palvelimen tiedot",
  "dialog.mcp.inspector.required": "Pakollinen",
}
