export const dict = {
  ...
  "session.timeline.steer": "Ohjaa heti",
  "session.timeline.queue": "Jonota",
  "session.timeline.steerHint": "Kirjoita ohjataksesi tämän vastauksen uudelleen",
  "session.timeline.queueHint": "Kirjoita jatkoviesti, joka lähetetään tämän vastauksen jälkeen",
