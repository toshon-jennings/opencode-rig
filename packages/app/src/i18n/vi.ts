export const dict = {
  ...
  "prompt.context.pin": "Ghim ngữ cảnh",
  "prompt.context.unpin": "Bỏ ghim ngữ cảnh",
  ...
  "home.project.none": "Không có dự án",
  "home.project.none.hint": "Bắt đầu phiên làm việc không có dự án",
  ...
  "session.timeline.steer": "Điều hướng",
  "session.timeline.queue": "Hàng đợi",
  "session.timeline.steerHint": "Nhập để đổi hướng phản hồi này",
  "session.timeline.queueHint": "Nhập tin nhắn tiếp theo để gửi sau phản hồi này",
  ...
  "status.popover.tab.providers": "Nhà cung cấp",
  ...
  "settings.providers.health.operational": "Hoạt động",
  "settings.providers.health.degraded": "Suy giảm",
  "settings.providers.health.unreachable": "Không thể truy cập",
  "settings.providers.autoDiscovery.banner": "Đã phát hiện các mô hình mới cho {{provider}}",
  ...
  "toast.followup.mode.queue": "Chế độ theo dõi được đặt thành Queue",
  "dialog.mcp.inspector.tools": "Công cụ đã kết nối",
  "dialog.mcp.inspector.noTools": "Không có công cụ nào được đăng ký cho máy chủ này",
  "dialog.mcp.inspector.notConnected": "Máy chủ chưa được kết nối",
  "dialog.mcp.inspector.schema": "Cấu trúc đầu vào",
  "dialog.mcp.inspector.expand": "Mở rộng chi tiết máy chủ",
  "dialog.mcp.inspector.collapse": "Thu gọn chi tiết máy chủ",
  "dialog.mcp.inspector.required": "Bắt buộc",
}
