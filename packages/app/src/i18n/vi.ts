export const dict = {
  ...
  "session.timeline.queue": "Xếp hàng",
  "session.timeline.steerHint": "Nhập để điều hướng lại phản hồi này",
  "session.timeline.queueHint": "Nhập nội dung tiếp theo để gửi sau phản hồi này",
