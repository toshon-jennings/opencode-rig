...
export const dict = {
  "desktop.updater.dialog.available.message": "更新 {{version}} 已可用。是否打开下载页面？",
  "desktop.updater.dialog.available.title": "更新可用",
  "desktop.updater.dialog.download": "下载",
  ...
  "prompt.context.pin": "固定上下文",
  "prompt.context.unpin": "取消固定上下文",
  ...
  "session.timeline.steer": "引导",
  "session.timeline.queue": "队列",
  "session.timeline.steerHint": "输入以调整此回复的方向",
  "session.timeline.queueHint": "输入要在此回复后发送的消息",
  ...
  "status.popover.tab.providers": "提供商",
  ...
  "settings.providers.health.operational": "运行正常",
  "settings.providers.health.degraded": "性能下降",
  "settings.providers.health.unreachable": "无法访问",
  "settings.providers.autoDiscovery.banner": "发现 {{provider}} 的新模型",
  ...
  "command.provider.health": "查看提供商运行状况",
  "command.provider.health.description": "检查提供商状态、连接状况和延迟",
  "command.followup.mode.toggle": "后续模式：{{mode}}",
  "command.followup.mode.toggle.description": "在 Steer 和 Queue 之间切换后续模式",
  "toast.followup.mode.title": "后续模式",
  "toast.followup.mode.steer": "后续模式已设为 Steer",
  "toast.followup.mode.queue": "后续模式已设为 Queue",
  "dialog.mcp.inspector.tools": "已连接的工具",
  "dialog.mcp.inspector.noTools": "此服务器未注册任何工具",
  "dialog.mcp.inspector.notConnected": "服务器未连接",
  "dialog.mcp.inspector.schema": "输入架构",
  "dialog.mcp.inspector.expand": "展开服务器详情",
  "dialog.mcp.inspector.collapse": "收起服务器详情",
  "dialog.mcp.inspector.required": "必填",
