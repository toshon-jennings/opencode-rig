export const dict = {
  ...
  "prompt.context.pin": "Sematkan konteks",
  "prompt.context.unpin": "Lepas sematan konteks",
  ...
  "status.popover.tab.providers": "Penyedia",
  ...
  "settings.providers.health.operational": "Operasional",
  "settings.providers.health.degraded": "Terganggu",
  "settings.providers.health.unreachable": "Tidak dapat dijangkau",
  "settings.providers.autoDiscovery.banner": "Model baru ditemukan untuk {{provider}}",
  ...
  "toast.followup.mode.queue": "Mode tindak lanjut diatur ke Queue",
  "dialog.mcp.inspector.tools": "Alat Terhubung",
  "dialog.mcp.inspector.noTools": "Tidak ada alat yang terdaftar untuk server ini",
  "dialog.mcp.inspector.notConnected": "Server tidak terhubung",
  "dialog.mcp.inspector.schema": "Skema Input",
  "dialog.mcp.inspector.expand": "Perluas detail server",
  "dialog.mcp.inspector.collapse": "Ciutkan detail server",
  "dialog.mcp.inspector.required": "Wajib",
}
