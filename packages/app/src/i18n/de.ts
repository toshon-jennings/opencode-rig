...
export const dict = {
  ...
  "prompt.context.pin": "Kontext anheften",
  "prompt.context.unpin": "Kontext lösen",
  ...
  "home.project.none": "Kein Projekt",
  "home.project.none.hint": "Eine Sitzung ohne Projekt starten",
  ...
  "status.popover.tab.providers": "Anbieter",
  ...
  "settings.providers.health.operational": "Betriebsbereit",
  "settings.providers.health.degraded": "Beeinträchtigt",
  "settings.providers.health.unreachable": "Nicht erreichbar",
  "settings.providers.autoDiscovery.banner": "Neue Modelle für {{provider}} entdeckt",
  ...
  "model.tag.tools": "Werkzeuge",
  "model.tooltip.tools": "Werkzeuge",
  "model.tooltip.tools.supported": "Werkzeugaufrufe unterstützt",
