export const dict = {
  ...
  "session.timeline.steer": "นำทาง",
  "session.timeline.queue": "คิว",
  "session.timeline.steerHint": "พิมพ์เพื่อเปลี่ยนทิศทางคำตอบนี้",
  "session.timeline.queueHint": "พิมพ์ข้อความติดตามเพื่อส่งหลังจากคำตอบนี้",
