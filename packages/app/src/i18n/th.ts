export const dict = {
  ...
  "prompt.context.pin": "ปักหมุดบริบท",
  "prompt.context.unpin": "เลิกปักหมุดบริบท",
  ...
  "session.timeline.steer": "กำหนดทิศทาง",
  "session.timeline.queue": "คิว",
  "session.timeline.steerHint": "พิมพ์เพื่อเปลี่ยนทิศทางการตอบนี้",
  "session.timeline.queueHint": "พิมพ์ข้อความที่จะส่งหลังการตอบนี้",
  ...
  "status.popover.tab.providers": "ผู้ให้บริการ",
  ...
  "settings.providers.health.operational": "ทำงานปกติ",
  "settings.providers.health.degraded": "ประสิทธิภาพลดลง",
  "settings.providers.health.unreachable": "ไม่สามารถเข้าถึงได้",
  "settings.providers.autoDiscovery.banner": "พบโมเดลใหม่สำหรับ {{provider}}",
  ...
  "model.tag.reasoning": "การใช้เหตุผล",
  "model.tag.vision": "การมองเห็น",
  "model.tag.tools": "เครื่องมือ",
  "model.tooltip.tools": "เครื่องมือ",
  "model.tooltip.tools.supported": "รองรับการเรียกใช้เครื่องมือ",
  ...
  "toast.followup.mode.queue": "ตั้งค่าโหมดการติดตามเป็น Queue",
  "dialog.mcp.inspector.tools": "เครื่องมือที่เชื่อมต่อ",
  "dialog.mcp.inspector.noTools": "ไม่มีเครื่องมือที่ลงทะเบียนสำหรับเซิร์ฟเวอร์นี้",
  "dialog.mcp.inspector.notConnected": "เซิร์ฟเวอร์ไม่ได้เชื่อมต่อ",
  "dialog.mcp.inspector.schema": "โครงสร้างข้อมูลอินพุต",
  "dialog.mcp.inspector.expand": "ขยายรายละเอียดเซิร์ฟเวอร์",
  "dialog.mcp.inspector.collapse": "ย่อรายละเอียดเซิร์ฟเวอร์",
  "dialog.mcp.inspector.required": "จำเป็น",
}
