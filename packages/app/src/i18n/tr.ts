...
export const dict = {
  ...
  "prompt.context.pin": "Bağlamı sabitle",
  "prompt.context.unpin": "Bağlamın sabitlemesini kaldır",
  ...
  "home.project.none": "Proje yok",
  "home.project.none.hint": "Projesiz bir oturum başlat",
  ...
  "session.timeline.steer": "Yönlendir",
  "session.timeline.queue": "Kuyruk",
  "session.timeline.steerHint": "Bu yanıtı yönlendirmek için yazın",
  "session.timeline.queueHint": "Bu yanıttan sonra gönderilecek bir mesaj yazın",
  ...
  "status.popover.tab.providers": "Sağlayıcılar",
  ...
  "settings.providers.health.operational": "Çalışıyor",
  "settings.providers.health.degraded": "Kısıtlı",
  "settings.providers.health.unreachable": "Ulaşılamıyor",
  "settings.providers.autoDiscovery.banner": "{{provider}} için yeni modeller keşfedildi",
  ...
  "command.provider.health": "Sağlayıcı durumunu görüntüle",
  "command.provider.health.description": "Sağlayıcı durumunu, bağlantı sağlığını ve gecikmeyi denetle",
  "command.followup.mode.toggle": "Takip modu: {{mode}}",
  "command.followup.mode.toggle.description": "Takip modunu Steer ve Queue arasında değiştir",
  "toast.followup.mode.title": "Takip modu",
  "toast.followup.mode.steer": "Takip modu Steer olarak ayarlandı",
  "toast.followup.mode.queue": "Takip modu Queue olarak ayarlandı",
  "dialog.mcp.inspector.tools": "Bağlı araçlar",
  "dialog.mcp.inspector.noTools": "Bu sunucu için kayıtlı araç yok",
  "dialog.mcp.inspector.notConnected": "Sunucu bağlı değil",
  "dialog.mcp.inspector.schema": "Giriş şeması",
  "dialog.mcp.inspector.expand": "Sunucu ayrıntılarını genişlet",
  "dialog.mcp.inspector.collapse": "Sunucu ayrıntılarını daralt",
  "dialog.mcp.inspector.required": "Gerekli",
