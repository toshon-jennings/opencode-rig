...
export const dict = {
  ...
  "session.timeline.queue": "Sıra",
  "session.timeline.steerHint": "Bu yanıtı yeniden yönlendirmek için yazın",
  "session.timeline.queueHint": "Bu yanıttan sonra gönderilecek bir takip mesajı yazın",
