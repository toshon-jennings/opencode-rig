export const dict = {
  ...
  "prompt.context.pin": "Fastgør kontekst",
  "prompt.context.unpin": "Frigør kontekst",
  ...
  "session.timeline.steerHint": "Skriv for at omdirigere dette svar",
  "session.timeline.queueHint": "Skriv en opfølgning, der sendes efter dette svar",
  ...
  "status.popover.tab.providers": "Udbydere",
  ...
  "settings.providers.health.operational": "I drift",
  "settings.providers.health.degraded": "Forringet",
  "settings.providers.health.unreachable": "Utilgængelig",
  "settings.providers.autoDiscovery.banner": "Nye modeller fundet for {{provider}}",
  ...
  "model.tag.reasoning": "Ræsonnering",
  "model.tag.vision": "Syn",
  "model.tag.tools": "Værktøjer",
  "model.tooltip.tools": "Værktøjer",
  "model.tooltip.tools.supported": "Understøtter værktøjskald",
  ...
  "toast.followup.mode.queue": "Opfølgningstilstand indstillet til Queue",
  "dialog.mcp.inspector.tools": "Tilsluttede værktøjer",
  "dialog.mcp.inspector.noTools": "Ingen værktøjer registreret for denne server",
  "dialog.mcp.inspector.notConnected": "Serveren er ikke tilsluttet",
  "dialog.mcp.inspector.schema": "Inputskema",
  "dialog.mcp.inspector.expand": "Fold serverdetaljer ud",
  "dialog.mcp.inspector.collapse": "Fold serverdetaljer sammen",
  "dialog.mcp.inspector.required": "Påkrævet",
}
