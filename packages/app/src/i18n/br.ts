export const dict = {
  ...
  "model.tag.reasoning": "Meizadiñ",
  "model.tag.vision": "Gwel",
  "model.tag.tools": "Ostiloù",
  "model.tooltip.tools": "Ostiloù",
  "model.tooltip.tools.supported": "Galaouel da c'halv ostiloù",
}
