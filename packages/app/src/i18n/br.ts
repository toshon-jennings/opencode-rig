export const dict = {
  "desktop.updater.dialog.available.message": "A atualização {{version}} está disponível. Abrir a página de download?",
  "desktop.updater.dialog.available.title": "Atualização disponível",
  ...
  "prompt.context.pin": "Fixar contexto",
  "prompt.context.unpin": "Desafixar contexto",
  ...
  "home.project.none": "Sem projeto",
  "home.project.none.hint": "Iniciar uma sessão sem projeto",
  ...
  "session.timeline.steer": "Direcionar",
  "session.timeline.queue": "Fila",
  "session.timeline.steerHint": "Digite para redirecionar esta resposta",
  "session.timeline.queueHint": "Digite uma mensagem para enviar após esta resposta",
  ...
  "status.popover.tab.providers": "Provedores",
  ...
  "settings.providers.health.operational": "Operacional",
  "settings.providers.health.degraded": "Degradado",
  "settings.providers.health.unreachable": "Inacessível",
  "settings.providers.autoDiscovery.banner": "Novos modelos descobertos para {{provider}}",
  ...
  "toast.followup.mode.queue": "Modo de acompanhamento definido para Queue",
  "dialog.mcp.inspector.tools": "Ferramentas conectadas",
  "dialog.mcp.inspector.noTools": "Nenhuma ferramenta registrada para este servidor",
  "dialog.mcp.inspector.notConnected": "O servidor não está conectado",
  "dialog.mcp.inspector.schema": "Esquema de entrada",
  "dialog.mcp.inspector.expand": "Expandir detalhes do servidor",
  "dialog.mcp.inspector.collapse": "Recolher detalhes do servidor",
  "dialog.mcp.inspector.required": "Obrigatório",
}
