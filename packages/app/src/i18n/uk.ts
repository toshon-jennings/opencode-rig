export const dict = {
  "desktop.updater.dialog.available.message": "Доступне оновлення {{version}}. Відкрити сторінку завантаження?",
  "desktop.updater.dialog.available.title": "Доступне оновлення",
  ...
  "prompt.context.pin": "Закріпити контекст",
  "prompt.context.unpin": "Відкріпити контекст",
  ...
  "session.timeline.steer": "Скерувати",
  "session.timeline.queue": "Черга",
  "session.timeline.steerHint": "Введіть текст, щоб змінити напрям цієї відповіді",
  "session.timeline.queueHint": "Введіть повідомлення, яке буде надіслано після цієї відповіді",
  ...
  "status.popover.tab.providers": "Провайдери",
  ...
  "settings.providers.health.operational": "Працює",
  "settings.providers.health.degraded": "Погіршено",
  "settings.providers.health.unreachable": "Недоступний",
  "settings.providers.autoDiscovery.banner": "Виявлено нові моделі для {{provider}}",
  ...
  "toast.followup.mode.queue": "Режим уточнення встановлено на Queue",
  "dialog.mcp.inspector.tools": "Підключені інструменти",
  "dialog.mcp.inspector.noTools": "Для цього сервера немає зареєстрованих інструментів",
  "dialog.mcp.inspector.notConnected": "Сервер не підключено",
  "dialog.mcp.inspector.schema": "Схема вводу",
  "dialog.mcp.inspector.expand": "Розгорнути детали сервера",
  "dialog.mcp.inspector.collapse": "Згорнути детали сервера",
  "dialog.mcp.inspector.required": "Обов'язково",
}
