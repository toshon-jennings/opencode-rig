export const dict = {
  ...
  "session.timeline.steer": "Керування",
  "session.timeline.queue": "Черга",
  "session.timeline.steerHint": "Введіть текст, щоб скоригувати цю відповідь",
  "session.timeline.queueHint": "Введіть продовження, яке буде надіслано після цієї відповіді",
