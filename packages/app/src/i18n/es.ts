export const dict = {
  "desktop.updater.dialog.available.message": "La actualización {{version}} está disponible. ¿Abrir la página de descarga?",
  "desktop.updater.dialog.available.title": "Actualización disponible",
  ...
  "prompt.context.pin": "Fijar contexto",
  "prompt.context.unpin": "Desfijar contexto",
  "prompt.context.tokens": "{{count}}t",
  ...
  "home.project.none": "Sin proyecto",
  "home.project.none.hint": "Iniciar una sesión sin proyecto",
  ...
  "status.popover.tab.providers": "Proveedores",
  ...
  "settings.providers.health.operational": "Operativo",
  "settings.providers.health.degraded": "Degradado",
  "settings.providers.health.unreachable": "Inaccesible",
  "settings.providers.autoDiscovery.banner": "Se descubrieron nuevos modelos para {{provider}}",
  ...
  "model.tag.reasoning": "Razonamiento",
  "model.tag.vision": "Visión",
  "model.tag.tools": "Herramientas",
  "model.tooltip.tools": "Herramientas",
  "model.tooltip.tools.supported": "Admite llamadas a herramientas",
  "command.provider.health": "Ver estado del proveedor",
  "command.provider.health.description": "Comprobar estado del proveedor, salud de conexión y latencia",
  "command.followup.mode.toggle": "Cambiar modo de seguimiento: {{mode}}",
  "command.followup.mode.toggle.description": "Cambiar modo de seguimiento entre Steer y Queue",
  "toast.followup.mode.title": "Modo de seguimiento",
  "toast.followup.mode.steer": "Modo de seguimiento establecido en Steer",
  "toast.followup.mode.queue": "Modo de seguimiento establecido en Queue",
  "dialog.mcp.inspector.tools": "Herramientas conectadas",
  "dialog.mcp.inspector.noTools": "No hay herramientas registradas para este servidor",
  "dialog.mcp.inspector.notConnected": "El servidor no está conectado",
  "dialog.mcp.inspector.schema": "Esquema de entrada",
  "dialog.mcp.inspector.expand": "Expandir detalles del servidor",
  "dialog.mcp.inspector.collapse": "Contraer detalles del servidor",
  "dialog.mcp.inspector.required": "Obligatorio",
}
