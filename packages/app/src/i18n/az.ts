export const dict = {
  ...
  "prompt.context.pin": "Konteksti bərkidin",
  "prompt.context.unpin": "Konteksti ayırın",
  ...
  "home.project.none": "Layihəsiz",
  "home.project.none.hint": "Layihəsiz sessiya başladın",
  ...
  "session.timeline.steer": "Yönləndir",
  "session.timeline.queue": "Növbə",
  "session.timeline.steerHint": "Bu cavabı yönləndirmək üçün yazın",
  "session.timeline.queueHint": "Bu cavabdan sonra göndərmək üçün davam mesajı yazın",
  ...
  "status.popover.tab.providers": "Təchizatçılar",
  ...
  "settings.providers.health.operational": "İşlək",
  "settings.providers.health.degraded": "Zəifləmiş",
  "settings.providers.health.unreachable": "Əlçatmaz",
  "settings.providers.autoDiscovery.banner": "{{provider}} üçün yeni modellər aşkarlandı",
  ...
  "model.tooltip.tools.supported": "Alət çağırışı dəstəklənir",
  ...
  "toast.followup.mode.queue": "Davam rejimi Queue olaraq təyin edildi",
  "dialog.mcp.inspector.tools": "Qoşulmuş alətlər",
  "dialog.mcp.inspector.noTools": "Bu server üçün heç bir alət qeydiyyata alınmayıb",
  "dialog.mcp.inspector.notConnected": "Server qoşulmayıb",
  "dialog.mcp.inspector.schema": "Daxiletmə sxemi",
  "dialog.mcp.inspector.expand": "Server təfərrüatlarını genişləndirin",
  "dialog.mcp.inspector.collapse": "Server təfərrüatlarını yığın",
  "dialog.mcp.inspector.required": "Mütləqdir",
}
