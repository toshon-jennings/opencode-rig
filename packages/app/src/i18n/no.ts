...
export const dict = {
  ...
  "prompt.context.pin": "Fest kontekst",
  "prompt.context.unpin": "Løsne kontekst",
  ...
  "status.popover.tab.providers": "Leverandører",
  ...
  "settings.providers.health.operational": "Operativ",
  "settings.providers.health.degraded": "Redusert",
  "settings.providers.health.unreachable": "Utilgjengelig",
  "settings.providers.autoDiscovery.banner": "Nye modeller funnet for {{provider}}",
  ...
  "home.project.none": "Ingen prosjekt",
  "home.project.none.hint": "Start en økt uten prosjekt",
  ...
  "command.provider.health": "Vis leverandørstatus",
  "command.provider.health.description": "Sjekk leverandørstatus, tilkobling og ventetid",
  "command.followup.mode.toggle": "Oppfølgingsmodus: {{mode}}",
  "command.followup.mode.toggle.description": "Bytt oppfølgingsmodus mellom Steer og Queue",
  "toast.followup.mode.title": "Oppfølgingsmodus",
  "toast.followup.mode.steer": "Oppfølgingsmodus satt til Steer",
  "toast.followup.mode.queue": "Oppfølgingsmodus satt til Queue",
  "dialog.mcp.inspector.tools": "Tilkoblede verktøy",
  "dialog.mcp.inspector.noTools": "Ingen verktøy er registrert for denne serveren",
  "dialog.mcp.inspector.notConnected": "Serveren er ikke tilkoblet",
  "dialog.mcp.inspector.schema": "Inndataskjema",
  "dialog.mcp.inspector.expand": "Vis serverdetaljer",
  "dialog.mcp.inspector.collapse": "Skjul serverdetaljer",
  "dialog.mcp.inspector.required": "Påkrevd",
