...
export const dict = {
  ...
  "prompt.context.pin": "Pin context",
  "prompt.context.unpin": "Unpin context",
  ...
  "home.project.none": "No project",
  "home.project.none.hint": "Start a session without a project",
  ...
  "session.timeline.steer": "Steer",
  "session.timeline.queue": "Queue",
  "session.timeline.steerHint": "Type to redirect this response",
  "session.timeline.queueHint": "Type a follow-up to send after this response",
  ...
  "command.followup.mode.toggle": "Follow-up mode: {{mode}}",
