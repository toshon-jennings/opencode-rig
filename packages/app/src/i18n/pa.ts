export const dict = {
  ...
  "prompt.context.pin": "ਸੰਦਰਭ ਪਿੰਨ ਕਰੋ",
  "prompt.context.unpin": "ਸੰਦਰਭ ਅਨਪਿੰਨ ਕਰੋ",
  ...
  "status.popover.tab.providers": "ਪ੍ਰਦਾਤਾ",
  ...
  "settings.providers.health.operational": "ਚਾਲੂ",
  "settings.providers.health.degraded": "ਘਟੀ ਕਾਰਗੁਜ਼ਾਰੀ",
  "settings.providers.health.unreachable": "ਪਹੁੰਚ ਤੋਂ ਬਾਹਰ",
  "settings.providers.autoDiscovery.banner": "{{provider}} ਲਈ ਨਵੇਂ ਮਾਡਲ ਮਿਲੇ",
  ...
  "toast.followup.mode.queue": "ਫ਼ਾਲੋ-ਅੱਪ ਮੋਡ Queue ਤੇ ਸੈੱਟ ਕੀਤਾ ਗਿਆ",
  "dialog.mcp.inspector.tools": "ਕਨੈਕਟ ਕੀਤੇ ਟੂਲ",
  "dialog.mcp.inspector.noTools": "ਇਸ ਸਰਵਰ ਲਈ ਕੋਈ ਟੂਲ ਰਜਿਸਟਰ ਨਹੀਂ ਹੈ",
  "dialog.mcp.inspector.notConnected": "ਸਰਵਰ ਕਨੈਕਟ ਨਹੀਂ ਹੈ",
  "dialog.mcp.inspector.schema": "ਇਨਪੁਟ ਸਕੀਮਾ",
  "dialog.mcp.inspector.expand": "ਸਰਵਰ ਵੇਰਵੇ ਵਿਸਤਾਰ ਕਰੋ",
  "dialog.mcp.inspector.collapse": "ਸਰਵਰ ਵੇਰਵੇ ਸਮੇਟੋ",
  "dialog.mcp.inspector.required": "ਲਾਜ਼ਮੀ",
}
