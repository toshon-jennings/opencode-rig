export const dict = {
  ...
  "session.timeline.steer": "سٹیئر",
  "session.timeline.queue": "قطار",
  "session.timeline.steerHint": "ਇਸ ਜਵਾਬ ਨੂੰ ਮੁੜ ਦਿਸ਼ਾ ਦੇਣ ਲਈ ਲਿਖੋ",
  "session.timeline.queueHint": "ਇਸ ਜਵਾਬ ਤੋਂ ਬਾਅਦ ਭੇਜਣ ਲਈ ਫਾਲੋ-ਅੱਪ ਲਿਖੋ",
