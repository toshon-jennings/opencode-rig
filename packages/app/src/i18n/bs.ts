export const dict = {
  ...
  "prompt.context.pin": "Zakači kontekst",
  "prompt.context.unpin": "Otkači kontekst",
  ...
  "status.popover.tab.providers": "Pružatelji",
  ...
  "settings.providers.health.operational": "Operativno",
  "settings.providers.health.degraded": "Oslabljeno",
  "settings.providers.health.unreachable": "Nedostupno",
  "settings.providers.autoDiscovery.banner": "Otkriveni su novi modeli za {{provider}}",
  ...
  "toast.followup.mode.queue": "Način praćenja postavljen na Queue",
  "dialog.mcp.inspector.tools": "Povezani alati",
  "dialog.mcp.inspector.noTools": "Nema registrovanih alata za ovaj server",
  "dialog.mcp.inspector.notConnected": "Server nije povezan",
  "dialog.mcp.inspector.schema": "Ulazna šema",
  "dialog.mcp.inspector.expand": "Proširi detalje servera",
  "dialog.mcp.inspector.collapse": "Skupi detalje servera",
  "dialog.mcp.inspector.required": "Obavezno",
}
