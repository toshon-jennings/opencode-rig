export const dict = {
  ...
  "session.timeline.steer": "فوری رہنمائی",
  "session.timeline.queue": "قطار",
  "session.timeline.steerHint": "اس جواب کا رخ بدلنے کے لیے لکھیں",
  "session.timeline.queueHint": "اس جواب کے بعد بھیجنے کے لیے فالو اپ لکھیں",
