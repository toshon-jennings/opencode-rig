export const dict = {
  "desktop.updater.dialog.available.message": "اپ ڈیٹ \u2068{{version}}\u2069 دستیاب ہے۔ ڈاؤن لوڈ صفحہ کھولیں؟",
  "desktop.updater.dialog.available.title": "اپ ڈیٹ دستیاب ہے",
  "desktop.updater.dialog.download": "ڈاؤن لوڈ کریں",
  ...
  "prompt.context.pin": "سیاق پن کریں",
  "prompt.context.unpin": "سیاق اَن پن کریں",
  ...
  "home.project.none": "کوئی پروجیکٹ نہیں",
  "home.project.none.hint": "پروجیکٹ کے بغیر سیشن شروع کریں",
  ...
  "session.timeline.steer": "رہنمائی",
  "session.timeline.queue": "قطار",
  "session.timeline.steerHint": "اس جواب کا رخ بدلنے کے لیے ٹائپ کریں",
  "session.timeline.queueHint": "اس جواب کے بعد بھیجنے کے لیے اگلا پیغام ٹائپ کریں",
  ...
  "status.popover.tab.providers": "فراہم کنندگان",
  ...
  "settings.providers.health.operational": "فعال",
  "settings.providers.health.degraded": "متاثر",
  "settings.providers.health.unreachable": "ناقابل رسائی",
  "settings.providers.autoDiscovery.banner": "{{provider}} کے لیے نئے ماڈلز ملے",
  ...
  "toast.followup.mode.queue": "فالو اپ موڈ Queue پر سیٹ کر دیا گیا",
  "dialog.mcp.inspector.tools": "منسلک ٹولز",
  "dialog.mcp.inspector.noTools": "اس سرور کے لیے کوئی ٹول درج نہیں ہے",
  "dialog.mcp.inspector.notConnected": "سرور منسلک نہیں ہے",
  "dialog.mcp.inspector.schema": "ان پٹ اسکیما",
  "dialog.mcp.inspector.expand": "سرور کی تفصیلات کھولیں",
  "dialog.mcp.inspector.collapse": "سرور کی تفصیلات بند کریں",
  "dialog.mcp.inspector.required": "ضروری",
}
