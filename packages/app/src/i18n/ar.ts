export const dict = {
  ...
  "prompt.context.pin": "تثبيت السياق",
  "prompt.context.unpin": "إلغاء تثبيت السياق",
  ...
  "session.timeline.steer": "توجيه",
  "session.timeline.queue": "قائمة الانتظار",
  "session.timeline.steerHint": "اكتب لإعادة توجيه هذا الرد",
  "session.timeline.queueHint": "اكتب رسالة متابعة لإرسالها بعد هذا الرد",
  ...
  "status.popover.tab.providers": "مزودو الخدمة",
  ...
  "settings.providers.health.operational": "يعمل",
  "settings.providers.health.degraded": "متدهور",
  "settings.providers.health.unreachable": "غير قابل للوصول",
  "settings.providers.autoDiscovery.banner": "تم اكتشاف نماذج جديدة لـ {{provider}}",
  ...
  "model.tooltip.tools.supported": "يدعم استدعاء الأدوات",
  ...
  "toast.followup.mode.queue": "تم ضبط وضع المتابعة على Queue",
  "dialog.mcp.inspector.tools": "الأدوات المتصلة",
  "dialog.mcp.inspector.noTools": "لا توجد أدوات مسجلة لهذا الخادم",
  "dialog.mcp.inspector.notConnected": "الخادم غير متصل",
  "dialog.mcp.inspector.schema": "مخطط الإدخال",
  "dialog.mcp.inspector.expand": "توسيع تفاصيل الخادم",
  "dialog.mcp.inspector.collapse": "طي تفاصيل الخادم",
  "dialog.mcp.inspector.required": "مطلوب",
}
