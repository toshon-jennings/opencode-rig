...
export const dict = {
  ...
  "prompt.context.pin": "釘選上下文",
  "prompt.context.unpin": "取消釘選上下文",
  ...
  "home.project.none": "無專案",
  "home.project.none.hint": "在沒有專案的情況下開始工作階段",
  ...
  "session.timeline.steer": "引導",
  "session.timeline.queue": "佇列",
  "session.timeline.steerHint": "輸入以調整此回覆的方向",
  "session.timeline.queueHint": "輸入要在此回覆後傳送的訊息",
  ...
  "status.popover.tab.providers": "供應商",
  ...
  "settings.providers.health.operational": "運作正常",
  "settings.providers.health.degraded": "效能下降",
  "settings.providers.health.unreachable": "無法連線",
  "settings.providers.autoDiscovery.banner": "發現 {{provider}} 的新模型",
  ...
  "model.tooltip.tools.supported": "支援工具呼叫",
  "command.provider.health": "查看供應商健康狀態",
  "command.provider.health.description": "檢查供應商狀態、連線健康狀況和延遲",
  "command.followup.mode.toggle": "後續模式：{{mode}}",
  "command.followup.mode.toggle.description": "在 Steer 和 Queue 之間切換後續模式",
  "toast.followup.mode.title": "後續模式",
  "toast.followup.mode.steer": "後續模式已設為 Steer",
  "toast.followup.mode.queue": "後續模式已設為 Queue",
  "dialog.mcp.inspector.tools": "已連線的工具",
  "dialog.mcp.inspector.noTools": "此伺服器未註冊任何工具",
  "dialog.mcp.inspector.notConnected": "伺服器尚未連線",
  "dialog.mcp.inspector.schema": "輸入結構描述",
  "dialog.mcp.inspector.expand": "展開伺服器詳細資料",
  "dialog.mcp.inspector.collapse": "收合伺服器詳細資料",
