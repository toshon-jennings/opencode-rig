export const dict = {
  "desktop.updater.dialog.available.message": "Uppdatering {{version}} är tillgänglig. Öppna nedladdningssidan?",
  "desktop.updater.dialog.available.title": "Uppdatering tillgänglig",
  "desktop.updater.dialog.download": "Ladda ned",
  ...
  "prompt.context.pin": "Fäst kontext",
  "prompt.context.unpin": "Lossa kontext",
  ...
  "status.popover.tab.providers": "Leverantörer",
  ...
  "settings.providers.health.degraded": "Försämrad",
  "settings.providers.health.unreachable": "Onåbar",
  "settings.providers.autoDiscovery.banner": "Nya modeller hittades för {{provider}}",
  ...
  "toast.followup.mode.queue": "Uppföljningsläge inställt på Queue",
  "dialog.mcp.inspector.tools": "Anslutna verktyg",
  "dialog.mcp.inspector.noTools": "Inga verktyg registrerade för denna server",
  "dialog.mcp.inspector.notConnected": "Servern är inte ansluten",
  "dialog.mcp.inspector.schema": "Indataschema",
  "dialog.mcp.inspector.expand": "Expandera serverdetaljer",
  "dialog.mcp.inspector.collapse": "Dölj serverdetaljer",
  "dialog.mcp.inspector.required": "Obligatorisk",
}
