export const dict = {
  ...
  "session.timeline.steer": "Sterowanie",
  "session.timeline.queue": "Kolejka",
  "session.timeline.steerHint": "Wpisz, aby przekierować tę odpowiedź",
  "session.timeline.queueHint": "Wpisz dalszą wiadomość, która zostanie wysłana po tej odpowiedzi",
