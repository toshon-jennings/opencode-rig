export const dict = {
  ...
  "prompt.context.pin": "Przypnij kontekst",
  "prompt.context.unpin": "Odepnij kontekst",
  ...
  "home.project.none": "Bez projektu",
  "home.project.none.hint": "Rozpocznij sesję bez projektu",
  ...
  "session.timeline.steer": "Pokieruj",
  "session.timeline.queue": "Kolejka",
  "session.timeline.steerHint": "Pisz, aby przekierować tę odpowiedź",
  "session.timeline.queueHint": "Napisz wiadomość, która zostanie wysłana po tej odpowiedzi",
  ...
  "status.popover.tab.providers": "Dostawcy",
  ...
  "settings.providers.health.operational": "Działa",
  "settings.providers.health.degraded": "Ograniczona sprawność",
  "settings.providers.health.unreachable": "Nieosiągalny",
  "settings.providers.autoDiscovery.banner": "Wykryto nowe modele dla {{provider}}",
  ...
  "model.tag.reasoning": "Wnioskowanie",
  "model.tag.vision": "Wizja",
  "model.tag.tools": "Narzędzia",
  "model.tooltip.tools": "Narzędzia",
  "model.tooltip.tools.supported": "Obsługuje wywoływanie narzędzi",
  ...
  "toast.followup.mode.queue": "Tryb kontynuacji ustawiony na Queue",
  "dialog.mcp.inspector.tools": "Połączone narzędzia",
  "dialog.mcp.inspector.noTools": "Brak zarejestrowanych narzędzi dla tego serwera",
  "dialog.mcp.inspector.notConnected": "Serwer nie jest połączony",
  "dialog.mcp.inspector.schema": "Schemat wejściowy",
  "dialog.mcp.inspector.expand": "Rozwiń szczegóły serwera",
  "dialog.mcp.inspector.collapse": "Zwiń szczegóły serwera",
  "dialog.mcp.inspector.required": "Wymagane",
}
