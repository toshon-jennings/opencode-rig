export const dict = {
  ...
  "session.timeline.steer": "Направлять",
  "session.timeline.queue": "Очередь",
  "session.timeline.steerHint": "Введите текст, чтобы скорректировать этот ответ",
  "session.timeline.queueHint": "Введите продолжение, которое будет отправлено после этого ответа",
