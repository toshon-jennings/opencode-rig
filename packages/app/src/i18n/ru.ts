export const dict = {
  "desktop.updater.dialog.available.message": "Доступно обновление {{version}}. Открыть страницу загрузки?",
  "desktop.updater.dialog.available.title": "Доступно обновление",
  ...
  "prompt.context.pin": "Закрепить контекст",
  "prompt.context.unpin": "Открепить контекст",
  ...
  "session.timeline.steer": "Направить",
  "session.timeline.queue": "Очередь",
  "session.timeline.steerHint": "Введите текст, чтобы изменить направление ответа",
  "session.timeline.queueHint": "Введите сообщение, которое будет отправлено после этого ответа",
  ...
  "status.popover.tab.providers": "Провайдеры",
  ...
  "settings.providers.health.operational": "Работает",
  "settings.providers.health.degraded": "Сниженная доступность",
  "settings.providers.health.unreachable": "Недоступен",
  "settings.providers.autoDiscovery.banner": "Обнаружены новые модели для {{provider}}",
  ...
  "toast.followup.mode.queue": "Установлен режим уточнения Queue",
  "dialog.mcp.inspector.tools": "Подключенные инструменты",
  "dialog.mcp.inspector.noTools": "Для этого сервера нет зарегистрированных инструментов",
  "dialog.mcp.inspector.notConnected": "Сервер не подключен",
  "dialog.mcp.inspector.schema": "Схема ввода",
  "dialog.mcp.inspector.expand": "Развернуть сведения о сервере",
  "dialog.mcp.inspector.collapse": "Свернуть сведения о сервере",
  "dialog.mcp.inspector.required": "Обязательно",
}
