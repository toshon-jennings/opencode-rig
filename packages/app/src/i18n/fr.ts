export const dict = {
  ...
  "session.timeline.steerHint": "Saisissez du texte pour réorienter cette réponse",
  "session.timeline.queueHint": "Saisissez un suivi à envoyer après cette réponse",
