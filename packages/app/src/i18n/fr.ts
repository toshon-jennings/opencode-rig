export const dict = {
  "desktop.updater.dialog.available.message": "La mise à jour {{version}} est disponible. Ouvrir la page de téléchargement ?",
  "desktop.updater.dialog.available.title": "Mise à jour disponible",
  ...
  "prompt.context.pin": "Épingler le contexte",
  "prompt.context.unpin": "Désépingler le contexte",
  ...
  "home.project.none": "Aucun projet",
  "home.project.none.hint": "Démarrer une session sans projet",
  ...
  "session.timeline.steer": "Orienter",
  "session.timeline.queue": "File d'attente",
  "session.timeline.steerHint": "Écrivez pour réorienter cette réponse",
  "session.timeline.queueHint": "Écrivez un message à envoyer après cette réponse",
  ...
  "status.popover.tab.providers": "Fournisseurs",
  ...
  "settings.providers.health.operational": "Opérationnel",
  "settings.providers.health.degraded": "Dégradé",
  "settings.providers.health.unreachable": "Injoignable",
  "settings.providers.autoDiscovery.banner": "De nouveaux modèles ont été découverts pour {{provider}}",
  ...
  "toast.followup.mode.queue": "Mode de suivi défini sur Queue",
  "dialog.mcp.inspector.tools": "Outils connectés",
  "dialog.mcp.inspector.noTools": "Aucun outil enregistré pour ce serveur",
  "dialog.mcp.inspector.notConnected": "Le serveur n'est pas connecté",
  "dialog.mcp.inspector.schema": "Schéma d'entrée",
  "dialog.mcp.inspector.expand": "Développer les détails du serveur",
  "dialog.mcp.inspector.collapse": "Réduire les détails du serveur",
  "dialog.mcp.inspector.required": "Requis",
}
