export const dict = {
  ...
  "session.timeline.steer": "Intervieni subito",
  "session.timeline.queue": "Coda",
  "session.timeline.steerHint": "Digita per reindirizzare questa risposta",
  "session.timeline.queueHint": "Digita un seguito da inviare dopo questa risposta",
