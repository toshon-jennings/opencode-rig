export const dict = {
  "desktop.updater.dialog.available.message": "È disponibile l’aggiornamento {{version}}. Aprire la pagina di download?",
  "desktop.updater.dialog.available.title": "Aggiornamento disponibile",
  ...
  "prompt.context.pin": "Fissa il contesto",
  "prompt.context.unpin": "Rimuovi il contesto",
  ...
  "session.timeline.steer": "Guida",
  "session.timeline.queue": "Coda",
  "session.timeline.steerHint": "Scrivi per reindirizzare questa risposta",
  "session.timeline.queueHint": "Scrivi un messaggio da inviare dopo questa risposta",
  ...
  "status.popover.tab.providers": "Provider",
  ...
  "settings.providers.health.degraded": "Degradato",
  "settings.providers.health.unreachable": "Non raggiungibile",
  "settings.providers.autoDiscovery.banner": "Nuovi modelli rilevati per {{provider}}",
  ...
  "toast.followup.mode.queue": "Modalità di follow-up impostata su Queue",
  "dialog.mcp.inspector.tools": "Strumenti collegati",
  "dialog.mcp.inspector.noTools": "Nessuno strumento registrato per questo server",
  "dialog.mcp.inspector.notConnected": "Il server non è connesso",
  "dialog.mcp.inspector.schema": "Schema di input",
  "dialog.mcp.inspector.expand": "Espandi dettagli server",
  "dialog.mcp.inspector.collapse": "Riduci dettagli server",
  "dialog.mcp.inspector.required": "Obbligatorio",
}
