export const dict = {
  "desktop.updater.dialog.available.message": "अपडेट {{version}} उपलब्ध है। डाउनलोड पेज खोलें?",
  "desktop.updater.dialog.available.title": "अपडेट उपलब्ध है",
  ...
  "prompt.context.pin": "संदर्भ पिन करें",
  "prompt.context.unpin": "संदर्भ अनपिन करें",
  ...
  "session.timeline.steer": "दिशा दें",
  "session.timeline.queue": "कतार",
  "session.timeline.steerHint": "इस उत्तर की दिशा बदलने के लिए टाइप करें",
  "session.timeline.queueHint": "इस उत्तर के बाद भेजने के लिए अगला संदेश टाइप करें",
  ...
  "status.popover.tab.providers": "प्रदाता",
  ...
  "settings.providers.health.operational": "चालू",
  "settings.providers.health.degraded": "बाधित",
  "settings.providers.health.unreachable": "पहुंच से बाहर",
  "settings.providers.autoDiscovery.banner": "{{provider}} के लिए नए मॉडल मिले",
  ...
  "toast.followup.mode.queue": "फ़ॉलो-अप मोड Queue पर सेट किया गया",
  "dialog.mcp.inspector.tools": "कनेक्टेड टूल",
  "dialog.mcp.inspector.noTools": "इस सर्वर के लिए कोई टूल पंजीकृत नहीं है",
  "dialog.mcp.inspector.notConnected": "सर्वर कनेक्ट नहीं है",
  "dialog.mcp.inspector.schema": "इनपुट स्कीमा",
  "dialog.mcp.inspector.expand": "सर्वर विवरण विस्तार करें",
  "dialog.mcp.inspector.collapse": "सर्वर विवरण समेटें",
  "dialog.mcp.inspector.required": "आवश्यक",
}
