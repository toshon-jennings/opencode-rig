export const dict = {
  ...
  "session.timeline.steer": "तुरंत निर्देश दें",
  "session.timeline.queue": "कतार",
  "session.timeline.steerHint": "इस जवाब को दूसरी दिशा देने के लिए लिखें",
  "session.timeline.queueHint": "इस जवाब के बाद भेजने के लिए फ़ॉलो-अप लिखें",
