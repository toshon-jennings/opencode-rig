export const dict = {
  ...
  "ui.sessionReviewV2.filters": "Фильтры",
  "ui.sessionReviewV2.filter.language": "Язык",
  "ui.sessionReviewV2.filter.tests": "Тесты",
  "ui.sessionReviewV2.filter.large": "Большие различия",
  "ui.lineComment.ask": "Спросить ИИ",
  "ui.sessionReviewV2.hunk": "Фрагмент {{number}}",
  "ui.sessionReviewV2.acceptSelected": "Принять выбранное",
  "ui.sessionReviewV2.rejectSelected": "Отклонить выбранное",
  ...
  "ui.promptInput.pin": "Закрепить контекст",
  "ui.promptInput.unpin": "Открепить контекст",
