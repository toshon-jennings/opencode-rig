...
export function WordmarkV2(props: Pick<ComponentProps<"svg">, "class">) {
  ...
  return (
    ...
    >
      <g opacity="0.6">
        <g mask={`url(#${mask})`}>
          <g opacity="0.16" fill="currentColor">
            ...
            <rect x="272" y="80" width="16" height="16" />
            ...
            <rect x="432" y="80" width="16" height="16" />
      ...
      <defs>
        <mask id={mask} style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="960" height="112">
          <rect width="960" height="112" fill={`url(#${maskGradient})`} />
        </mask>
        <linearGradient id={maskGradient} x1="480" y1="56" x2="480" y2="112" gradientUnits="userSpaceOnUse">
